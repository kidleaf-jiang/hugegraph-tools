...
public class DumpKGFormatter implements Formatter {
    ...
    // entity dump format："plant_id value key weight type parent parent_weight
    ...
    private String dumpEntity(JsonVertex vertex)
        ...
        String planId = (String) properties.get("plain_id");
        String seqPlainId = cs.computeSeqNum(planId);
